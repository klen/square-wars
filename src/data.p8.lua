...
missions = {
  ...
  load_table_str "n=intro,s=5,p=1", -- 1
  load_table_str "n=tutor,s=8,p=2,un=continue", -- 2
  load_table_str "n=qualification,s=12,p=3", -- 3
  load_table_str "n=exam,s=15,p=4,u=practice,un=practice mode", -- 4
  load_table_str "n=infiltration,s=20,a=2,p=2,u=arena,un=arena 1", -- 5
  load_table_str "n=brothers,s=20,a=3,p=2,u=arena,un=arena 2", -- 6
  load_table_str "n=the mirror,s=20,a=4,p=2,u=arena,un=arena 3", -- 7
  load_table_str "n=the crystal,s=20,a=5,p=3,u=arena,un=arena 4", -- 8
  load_table_str "n=labyrinth,s=20,a=6,p=3,u=arena,un=arena 5", -- 9
  load_table_str "n=cage,s=20,a=7,p=4,u=arena,un=arena 6", -- 10
  load_table_str "n=lines,s=20,a=8,p=4,u=arena,un=arena 7", -- 11
}

...
ARENAS = {
  ...
  split "apex,3,7,14,18,24,26,35,37,41,44,46,55,57,60,62,63,66,75,78,79,87,94,102,103,104,108,113,117,118,119,121,125,129,130,131,132,136,140,146,148,153,155,167,174,187,194,207,214,227,234,246,248,253,255,261,265,269,270,271,272,276,280,282,283,284,288,293,297,298,299,307,314,322,323,326,335,338,339,341,344,346,355,357,360,364,366,375,377,383,387,394,398",
  ...
  split "fire,8,13,24,37,62,64,66,69,72,75,77,79,104,106,115,117,121,127,134,148,153,160,164,169,172,177,190,191,210,211,224,229,232,237,248,253,260,261,267,274,284,286,295,297,322,324,326,329,332,335,337,339,364,377,388,393",
...
MISSIONS = {
  ...
  load_table_str "n=infiltration,a=2,cpu=1,u=arena,un=arena 1", -- 5

  load_table_str "n=snow's trial,a=11,w=1,cpu=2,u=power,un=power of snow,uv=1", -- 6 (snow)
  load_table_str "n=brothers,a=3,w=1,cpu=1/2,u=arena,un=arena 2", -- 7

  load_table_str "n=fire's challenge,a=12,w=3,cpu=1/2,u=power,un=power of fire,uv=3", -- 8 fire
  load_table_str "n=the mirror,a=4,w=3,cpu=2/2,u=arena,un=arena 3", -- 9

  load_table_str "n=desert's test,a=13,w=7,cpu=2/2,u=power,un=power of desert,uv=7", -- 10 desert
  load_table_str "n=the crystal,a=5,w=7,cpu=1/2/2,u=arena,un=arena 4", -- 11

  load_table_str "n=sun's wrath,a=14,w=15,cpu=1/2/2,u=power,un=power of sun,uv=15", -- 12 sun
  load_table_str "n=labyrinth,a=6,w=15,cpu=2/2/2,u=arena,un=arena 5", -- 13

  load_table_str "n=wood's guardian,a=15,w=31,cpu=2/2/2,u=power,un=power of woods,uv=31", -- 14 woods
  load_table_str "n=cage,a=7,w=31,cpu=2/2/2,u=arena,un=arena 6", -- 15

  load_table_str "n=storm's dominion,a=16,w=63,cpu=2/2/2,u=power,un=power of woods,uv=63", -- 16 woods
  load_table_str "n=lines,a=8,w=63,cpu=2/2/2,u=arena,un=arena 7", -- 18

  load_table_str "n=apex,a=9,w=63,cpu=2/2/2,un=mastery of all powers", -- 19
}
...
BRIEFS = {
  ...
  "masters of woods appear.\n\n\nthe field thickens\n\nwith obstacles\n\nonly the cunning will prevail.",
  "three foes join.\n\n\nnavigate this dense\n\ngrid of walls and\n\nclaim your victory.",
